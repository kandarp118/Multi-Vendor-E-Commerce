                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <div class="d-flex justify-content-between">
                            <h1 class="h3 text-gray-800 col-sm-6 p-0 m-0"> Sub-Category </h1>
                        ...
                        <button type="button" id="addshow" class="d-none d-sm-inline-block btn btn-md btn-warning shadow-sm"><i class="fas fa-cart-plus text-white"></i> Add Sub Category</button>
                    </div>

                    <!-- ADD BRAND -->
                    <div class="row justify-content-center" style="display: none;" id="add_sub_category">
                                                ...
                                                <form class="user needs-validation" method="POST" novalidate>
                                                    <div class="form-group row">
                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                            <input type="text" name="s_ca_name" class="form-control form-control-user"
                                                            id="sub_category_name"                                                            placeholder="Enter Brand Name ..." autocomplete="off" required>
                                                        </div>
                                                        <div class="col-sm-6">
                                                        <?php
                                                            ...
                                                            <select name="acid" class="form-control " id="category_id" style="border-radius: 25px 25px;padding: 5px 12px;font-size: 0.8rem;height: 50px; -webkit-appearance: none;" required>
                                                                ...
                                                                <?php
                                                                while($fc=mysqli_fetch_array($select_category_ans)){
                                                                    ?>  
                                                                    <option value="<?php echo $fc[0] ?>"><?php echo $fc[1] ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
                                                    ...
                                                    <div class="row justify-content-around mt-4">
                                                        ...
                                                        <input id="add_sub_category_btn" type="submit" value="Save" name="add_brand" class="btn btn-success btn-user col-5">    
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
