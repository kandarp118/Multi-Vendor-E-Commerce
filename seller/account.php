...
<div class="container-fluid py-5">
    <div class="container">
        ...
        <div class="row">
            <!-- profile -->
            <a href="sell_profile.php" class="col-xl-4 col-md-6 mb-4 text-decoration-none">
            ...
            <!-- product -->
            <a href="sell_pro.php" class="col-xl-4 col-md-6 mb-4 text-decoration-none">
                <div class="card border-0 shadow py-2"  onmouseover="this.style.backgroundColor='#e9ecef'" onmouseout="this.style.backgroundColor='white'">
                    <div class="card-body">
                        <div class="row justify-content-center no-gutters">
                            <div class="col-lg-12 text-center">
                                <i class="fas fa-boxes fs-1 my-2"></i>
                            </div>
                            <div class="col-lg-12 text-center">
                                <div class="fs-3 fw-bold text-warning my-2">
                                    Your Products
