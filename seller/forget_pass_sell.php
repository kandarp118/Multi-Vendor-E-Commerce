    ...
    <div class="container px-4 py-4">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-5 card border-0 shadow o-hidden p-4">
                ...
                <!-- <hr> -->
                <form class="row justify-content-center g-1 needs-validation" id="forgetPassFormSell" method="POST" novalidate>
                    <div class="col-12">
                    ...
                    <div class="row col-6 mt-4 me-3">
                        ...
                        <a href="sign_in_sell.php" class="btn btn-danger rounded-5">Back</a>
                    </div>
           ...
           (() => { 'use strict';
            ...
            Array.from(forms).forEach(form => {
                ...
                if (form.checkValidity()) {
                    let form_data = new FormData($('#forgetPassFormSell')[0]); // Correct selector
                    if ($('#email').val() != '' || $('#mobile').val() != '')
                    {
                        $("#invalid").hide();
                        $.ajax({
                            url: 'forget_pass_sell_code.php',
                            cache: false,
                            contentType: false,
                            processData: false,
                            data: form_data,
                                ...
                                if (ans === "success") {
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            window.location.href = 'create_pass_sell.php';
                                        }
                                    });
                                } else {
                                    Swal.fire({
