...
<html lang="en">
  <head>
    ...
    <title>Multi-Vendor Login</title>
            ...
            <div class="col-12 col-md-8 col-lg-5 card border-0 shadow o-hidden p-4">
                ...
                <form class="row justify-content-center g-3 needs-validation" id="SignInForm" method="POST" novalidate>
                    ...
                    <div class="col-12">
                        ...
                        <input type="Password" name="upass" class="form-control" id="password" required>
                    </div>  
                    <div class="col-6">
                    ...
                    <div class="col-6 text-end">
                        <a href="forget_pass.php" class="float-end">Forget Password?</a>
                    </div>
                    <div class="row col-12 mt-3">
                        <button class="btn btn-warning rounded-5" type="submit">Sign in</button>
                    </div>
                    <div class="col-12 text-center mt-3"><p>Don't have an account? <a href="sign_up.php">Sign up</a></p></div>
                </form>
            </div>
        </div>
    </div>
